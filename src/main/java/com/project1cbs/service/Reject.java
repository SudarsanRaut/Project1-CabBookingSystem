...
public class Reject extends HttpServlet {
    ...
    public static final Logger logger = LogManager.getLogger(Reject.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		logger.info("In reject service class....");
		try {
			if(rq != null) {
				rq.rejectRequest(BookingReqId);
				out.println("<!DOCTYPE html>\r\n"
						...
						+ "\r\n"
						+ "    <body>\r\n"
						+ "        <h1 style=\"color:white;text-align:center;\">Cab Rejected successfully!</h1>\r\n"
