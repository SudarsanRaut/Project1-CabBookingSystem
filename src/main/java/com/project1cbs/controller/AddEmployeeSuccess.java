...
/**
 * Servlet implementation class AddEmployeeSuccess
 */
public class AddEmployeeSuccess extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<!DOCTYPE html>\r\n"
				...
				+ "\r\n"
				+ "    <body>\r\n"
				+ "        <h1 style=\"color:white;text-align:center;\">Employee added successfully!</h1>\r\n"
				+ "\r\n"
				+ "        <body>\r\n"
